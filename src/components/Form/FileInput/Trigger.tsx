...
export function Trigger() {
  ...
  return (
    <label
      htmlFor={id}
      className={twMerge(
        'group flex flex-1 cursor-pointer flex-col items-center gap-3',
        'rounded-lg border border-zinc-300 px-6 py-4 text-center text-zinc-500 shadow-sm hover:bg-violet-25 hover:text-violet-500',
    ...
    >
      ...
      >
        <UploadCloud className="dark:grou-hover:text-violet-300 h-5 w-5 text-zinc-600 group-hover:text-violet-600 dark:text-zinc-500" />
      </div>
